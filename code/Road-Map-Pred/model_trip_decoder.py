...
# -- UNet specific model for triple decoder
...
class UNet_Encoder_Decoder(nn.Module):
    def __init__(self, in_channels=3, args=None):
        ...
        self.roadmap_decoder = UNet_Decoder()
        self.objdet_decoder = UNet_Decoder()
    ...
    def forward(self, x):
        ...
        decoder_roadmap_output = self.decoder(encoder_output)
        decoder_objdet_output = self.decoder(encoder_output)
        return decoder_roadmap_output, decoder_objdet_output, decoder_depth_output
